...
<body>
    ...
    <nav class="navbar navbar-dark fixed-top p-0 shadow" style="background-color: #363636;">
        <a href="Dashboard.php" class="navbar-brand col-sm-3 col-md-2 mr-0" style="padding-left: 20px; height:80px;">Edu-Ceylon <small class="text-white">Admin Panel</small></a>
    </nav>
