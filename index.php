...
<section class="categories reveal">
    <div class="container categories__container">
        <div class="categories__left">
            <h1>Categories</h1>
            <p>Students can learn their Subjects very easily with good knowledge capacity from Edu Ceylon Academy.</p>
        </div>
    ...
    <div class="container courses__container">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                <h4 style="text-align: start; margin-top: 10px;">Lkr ' . $row['course_price'] . '</h4>
                <br>
                    <a href="CourseDetails.php?course_id='.$course_id.'">
